...
Полностью законченный проект настольных часов на шести ламповых семисегментных индикаторах. Для устройства были разработаны прошивка, схемотехника и собственные печатные платы; готовая ревизия собрана и проверена в работе.

## Готовое устройство

![Ламповые часы на готовых печатных платах](docs/images/lamp-closeup.jpg)

*Шесть ламповых индикаторов в работе: отображение часов, минут и секунд.**

![Плата индикации с шестью лампами](docs/images/pcb-closeup.jpg)

*Плата индикации с шестью лампами и дискретными каскадами управления сегментами.*

![Разобранные платы часов](docs/images/disassembled-boards.jpg)
...
> В раннем прототипе уже работали отображение времени и часть настроек. Игры, плавные переходы между цифрами и готовые печатные платы появились позднее.
