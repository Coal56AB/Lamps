...
static Melody_t SFX_Beep = {song_length(SFX_Beep_Notes), SFX_Beep_Notes, {10U, 10U}};
...
static Melody_t SFX_DoubleBeep = {song_length(SFX_DoubleBeep_Notes), SFX_DoubleBeep_Notes, {10U, 10U}};
...
static Melody_t SFX_Error = {song_length(SFX_Error_Notes), SFX_Error_Notes, {10U, 10U}};
...
static Melody_t SFX_Success = {song_length(SFX_Success_Notes), SFX_Success_Notes, {10U, 10U}};

// Нажатие кнопки
static const MelodyStep_t SFX_Click_Notes[] = {
    {{DO4, NOTE_THIRTYSECOND}, {NOTE_REST, NOTE_THIRTYSECOND}}
};
static Melody_t SFX_Click = {song_length(SFX_Click_Notes), SFX_Click_Notes, {10U, 10U}};
...
static Melody_t SFX_Alarm = {song_length(SFX_Alarm_Notes), SFX_Alarm_Notes, {10U, 10U}};
...
static Melody_t SFX_Victory = {song_length(SFX_Victory_Notes), SFX_Victory_Notes, {10U, 10U}};
